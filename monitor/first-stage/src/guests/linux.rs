...
static COMMAND_LINE: &'static [u8] =
    b"root=/dev/sdb2 apic=debug earlyprintk=serial,ttyS0 console=ttyS0 iommu=off tyche.use_reserved_memory=1 tyche.reserved_base=0x200000000 tyche.reserved_size=4 memmap=4G$0x200000000\0";
#[cfg(feature = "bare_metal")]
static COMMAND_LINE: &'static [u8] =
    b"root=/dev/sdb2 apic=debug earlyprintk=serial,ttyS0,115200 console=ttyS0,115200 tyche.use_reserved_memory=1 tyche.reserved_base=0x200000000 tyche.reserved_size=4 memmap=4G$0x200000000\0";
