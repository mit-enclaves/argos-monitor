...
pub const SET_VMCS: usize = 14;
pub const VMREAD: usize = 15;
pub const VMWRITE: usize = 16;
pub const VMCLEAR: usize = 17;
pub const VMPTRLD: usize = 18;
pub const VMINVVPID: usize = 19;
pub const VMINVEPT: usize = 20;
pub const VMLAUNCH: usize = 21;
