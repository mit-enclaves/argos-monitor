...
This is a fork used for Tyche repo. Original repository is https://github.com/jedisct1/rust-ed25519-compact/tree/master. Repository is not put as a submodule to pass out CI checks and not force us to pull all submodules into CI, which would be slow during every check.
