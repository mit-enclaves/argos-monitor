...
pub mod sbi {
    ...
    pub const ECALL_VERSION_MINOR: u64 = 0;
    pub const ECALL_VERSION_MAJOR: u64 = 1;
    pub const SPEC_VERSION_MAJOR_MASK: u64 = 0x7f;
    pub const SPEC_VERSION_MAJOR_OFFSET: u64 = 24;
}
