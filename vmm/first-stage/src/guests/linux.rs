...
static COMMAND_LINE: &'static [u8] =
    b"root=/dev/sdb2 apic=debug earlyprintk=serial,ttyS0 console=ttyS0 nokaslr\0";
#[cfg(feature = "bare_metal")]
static COMMAND_LINE: &'static [u8] =
    b"root=/dev/sdb2 apic=debug show_lapic=all nokaslr earlyprintk=serial,ttyS0,115200 console=ttyS0,115200 pci=earlydump nr_cpus=1\0";
